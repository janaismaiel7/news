...
class Categoryy {
  ...
  static List<Categoryy> getCategories(){
    return [
      ...
      Categoryy(color: Appcolors.redColor, imagePath: "assets/images/health.png", id: 'health', title: "health"),
      Categoryy(color: Appcolors.lightBrownColor, imagePath: "assets/images/bussines.png", id: 'business', title: "business"),
     Categoryy(color: Appcolors.redColor, imagePath: "assets/images/environment.png", id: 'entertainment', title: "entertainment"),
      Categoryy(color: Appcolors.yellowColor, imagePath: "assets/images/science.png", id: 'science', title: "science"),
       Categoryy(color: Appcolors.blueColor, imagePath: "assets/images/science.png", id: 'technology', title: "technology"),
    ];
  }
}